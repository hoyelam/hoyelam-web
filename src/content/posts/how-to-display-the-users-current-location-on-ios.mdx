...
seoTitle: "How to Display a User’s Current Location on iOS"
description: "Build an iOS location flow with Core Location, SwiftUI, permission handling, published state, and a map centered on the user’s current position."
featured: true
relatedPosts:
  [
...
![Location permission description configured in an iOS app Info.plist](/images/imported/2022/08/CleanShot-2022-08-28-at-14.25.21-2x-78a50d69e1.png)
...
![SwiftUI map following a simulated current location in the iOS Simulator](/images/imported/2022/08/CleanShot-2022-08-31-at-19.49.25-b155e0f2ca.gif)
